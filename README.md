...
*   **Embeddings & LLM:** Google Gemini (`gemini-2.5-flash` and `gemini-embedding-001` / `gemini-embedding-2-preview` with automatic fallback to bypass region locks on free keys).
